...
export default function Navbar() {
    ...
    return (
        ...
        <nav className="fixed top-0 left-0 w-full py-3 sm:py-4 px-3 sm:px-6 lg:px-8 z-50 backdrop-blur-md bg-white/90 border-b border-gray-100 transition-all duration-300">
            ...
            <div className="flex justify-between items-center gap-3 w-full">
                ...
                >
                    ...
                    <div className="flex flex-col leading-none">
                        ...
                        <span className="text-lg sm:text-xl font-bold tracking-wide text-gray-900">
                            Mode
                        ...
                        <span className="text-[8px] sm:text-[9px] uppercase tracking-[3px] sm:tracking-[4px] text-gray-400 mt-0.5">
                            Fashion Store
                        </span>
                ...
                <div className="flex items-center gap-3 sm:gap-4 shrink-0">
                    <div className="relative hidden md:block">
                        ...
                        <Input
                            ...
                            className="w-40 lg:w-48 pl-9 pr-3 py-2 text-sm rounded-lg bg-gray-50 border border-gray-200 text-gray-900 focus:ring-2 focus:ring-blue-200 focus:border-blue-300 outline-none transition-all"
                            placeholder="Search..."
                        />
                    ...
                    {user ? (
                        <div className="flex items-center gap-2">
                            <Link
                                href="/profile"
                                className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg hover:bg-gray-100 transition-colors group"
                            >
                                ...
                                <span className="text-sm text-gray-700 font-medium group-hover:text-gray-900 transition-colors hidden lg:block">
                                    {user.firstName}
                                </span>
                            </Link>
                    ...
                    >
                        ...
                        <span
                            className={`block w-5 h-0.5 bg-gray-700 rounded transition-all duration-300 ${open ? "rotate-45 translate-y-2" : ""}`}
                        />

                        <span
                            className={`block w-5 h-0.5 bg-gray-700 rounded transition-all duration-300 ${open ? "opacity-0" : ""}`}
                        />
            ...
            >
                ...
                <div className="pt-4 border-t border-gray-100 mt-3 flex flex-col gap-1">
