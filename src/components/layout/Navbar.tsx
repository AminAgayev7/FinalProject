            ...
            <div className="w-full flex flex-wrap items-center justify-between px-2 sm:px-4 md:px-6 lg:px-8 py-4">
                ...
                <div className={`w-full md:flex md:w-auto md:items-center md:order-1 transition-all duration-300 ease-in-out ${open ? "block" : "hidden"}`}>
                    ...
                    <ul className="flex flex-col justify-center items-start mt-2 p-4 md:p-0 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row lg:gap-x-15 sm:gap-x-8 md:mt-0 md:border-0 md:bg-white">
                        ...
                        {user ? (
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-4 py-2 md:py-0 pl-3 md:pl-0">
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-3 py-2 md:py-0 pl-3 md:pl-0">
                                <Link href="/auth/login" className="text-sm text-gray-700 hover:text-blue-600 transition-colors">
                                    Login
                                </Link>
                                <Link href="/auth/register" className="text-sm bg-black text-white px-4 py-1.5 rounded-lg hover:bg-gray-800 transition-colors">
                                    Register
                                </Link>
                            </div>
                        )}
